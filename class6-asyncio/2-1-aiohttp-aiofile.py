...
async def write_genre(file_name):
    ...
    async with aiohttp.ClientSession() as seesion:
        async with seesion.get("https://binaryjazz.us/wp-json/genrenator/v1/genre/") as response:
...
async def main():
    ...
    print(f"Time to complete asynico read/writes:{round(end - start,2)}seconds")
